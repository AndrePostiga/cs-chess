...
class Timer():
    ...
    def __init__(self, window: window.Window):
        ...
        self.textlb = self.text.render\
            ("Timer Jogador 1: %d min %d s" %
             (self.time_spent1 // 60, self.time_spent1 % 60),
                                       True, (0, 0, 0))

        self.text2 = pygame.font.SysFont(name="monospace",size=35)
        self.textlb2 = self.text2.render\
            ("Timer Jogador 2: %d min %d s" %
             (self.time_spent2 // 60, self.time_spent2 % 60),True, (0, 0, 0))
    ...
    def timeP1(self):
        ...
        self.window.width - self.textlb.get_width(),
        self.window.height - self.textlb.get_height()))
        #self.window.screen.blit(self.textlb2, (0, 0))
        ...
        if time_diff >= 0.001:
            self.textlb = self.text.render\
                ("Timer Jogador 1: %d min %d s" %
                 (self.time_spent1 // 60, self.time_spent1 % 60),True, (0, 0, 0))
